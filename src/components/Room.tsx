      ...
      <div style={{display: 'flex', gap: '16px', flexWrap: 'wrap'}}>
        {CARDS.map((c) => (
          <motion.div
            ...
            onClick={() => { setCard(c); setFetchKey(k => k + 1); }}
            style={{
              aspectRatio: '2.5/3.5',
              height: '120px',
              borderRadius: '10px',
              ...
              {gifs.map((gif) => (
                ...
                >
                  <img
                    ...
                    style={{height: '160px', aspectRatio: `${gif.media_formats.gif.dims[0]} / ${gif.media_formats.gif.dims[1]}`, borderRadius: '8px', objectFit: 'cover'}}
                  />
                  <span style={{fontSize: '0.75rem', color: '#6b7280', textAlign: 'center', maxWidth: '100%', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>
                    {gif.title}
                  </span>
                </motion.div>
              ))}
